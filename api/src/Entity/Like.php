 ...
 * @ApiFilter(SearchFilter::class, properties={"resource": "exact", "author": "exact"})
 */
class Like
{
    /**
    ...
    /**
     * @var string A specific commonground resource that is being liked, e.g a single product
     *
