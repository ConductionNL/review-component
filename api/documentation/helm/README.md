# review-component chart

The Helm chart installs review-component and by default the following dependencies using subcharts:
...
```bash
helm repo add review-component https://raw.githubusercontent.com/ConductionNL/review-component/master/api/helm/
helm repo update
```
...
```bash
helm install my-review-component ConductionNL/review-component --version 0.1.0
```
...
| `settings.subdomain` | the subdomain of the installation excluding www. | `review-component` |
| `settings.subpath` | Any sub path to follow the domain, like /api/v1 | `review-component` |
